...
def seed_users():
    ...
    user2 = User('Luigi2', 'Luigi', 'Montemurra', 'gigi@gigi.com', 'Gigi dances Salsa and Tango', 'Portland', '97222','Salsa Nights, Milonga Canaro')
    user3 = User('Jelli', 'Angelica', 'Perisco', 'jellybean@jelli.com', 'Angelica loves to dance Salsa, Swing, and Blues', 'Vancouver', '98683', 'Salsa Nights, SwingLoft, Blues Boogie')
    user4 = User('Bengiii', 'Bengi', 'Beyaz', 'bengibeats@bengi.com', 'Bengi grooves to Hip Hop, Swing, and Blues', 'Portland', '97266','QuestLove Hip Hop, SwingLoft, Blues PDX')
    user5 = User('CutieRutie', 'Rutabega', 'Gardner', 'qtrutie@rutie.com', 'Rutie is new to dancing Swing, but loves to Applejack', 'Portland','97217', 'SwingLoft, LindyTime')
    user6 = User('Shandi', 'Shandor', 'Lokacs', 'shandorl@shandorl.com', 'Shandor just moved from Budapest. He enjoys Tango, Blues, and Salsa', 'Portland', '97218', 'Milonga Canaro, Milonga Sentimental, Salsa Nights, Blues PDX')
    user7 = User('Bahar82', 'Bahar', 'Deniz', 'bahar82@bahar.com', 'Bahar gets down to Hip Hop beats and soulful Blues', 'Portland', '97201','QuestLove Hip Hop, Blues PDX, Blues Boogie')
    user8 = User('JRome', 'Jerome', 'Cooper', 'jcooper@cooper.com', 'Jerome is a seasoned dancer (10 yrs) in Blues and Swing', 'Oregon City', '97045', 'SwingLoft, LindyTime, Blues Boogie, Blues PDX')
    user9 = User('Giu90', 'Giulia', 'Gigli', 'giu90@giulia.com', 'Giulia dances Tango and Salsa in Sardegna and PDX', 'Portland', '97222', 'Milonga Canaro, Milonga Sentimental, Salsa Nights')
    user10 = User('Titus', 'Titus', 'Castana', 'titusc@titus.com', 'Titus is a Milonguero solomente!', 'Portland', '97232','Milonga Canaro, Milonga Sentimental, Milonga Noches Azul') 
